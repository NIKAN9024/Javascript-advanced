...
const goedkopePrijzen = prijzen.filter(prijs => prijs < 100);/* jouw code hier */
console.log('Prijzen onder €100:', goedkopePrijzen);

// TODO: Filter productnamen die beginnen met 'm'
const productenMetM = productnamen.filter( naam => naam.startsWith('m'));/* jouw code hier */
console.log('Muis, monitor', productenMetM);
